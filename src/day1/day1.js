...
const extractNumbersFromString = (inputString) => {
  ...
  for (let i = 0; i < inputString.length; i += 1) {
    ...
    if (inputString.substring(i).startsWith('one')) {
      numberString += 1
    }
    if (inputString.substring(i).startsWith('two')) {
      numberString += 2
    }
    if (inputString.substring(i).startsWith('three')) {
      numberString += 3
    }
    if (inputString.substring(i).startsWith('four')) {
      numberString += 4
    }
    if (inputString.substring(i).startsWith('five')) {
      numberString += 5
    }
    if (inputString.substring(i).startsWith('six')) {
      numberString += 6
    }
    if (inputString.substring(i).startsWith('seven')) {
      numberString += 7
    }
    if (inputString.substring(i).startsWith('eight')) {
      numberString += 8
    }
    if (inputString.substring(i).startsWith('nine')) {
      numberString += 9
    }
  }
...
const run = () => {
  ...
  for (const line of lines) {
    const lineNumbers = extractNumbersFromString(line)
