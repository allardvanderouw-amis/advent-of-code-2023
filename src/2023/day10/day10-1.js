...
const run = () => {
  ...
  if (grid[startingPoint.y - 1][startingPoint.x] !== '.') {
    // Top is connected
  ...
  for (let connectedGridItem of connectedGridItems) {
    ...
    while (true) {
      ...
      console.log({
        prevGridItem: grid[prevGridItem.y][prevGridItem.x],
        gridItem: grid[gridItem.y][gridItem.x],
      })
  ...
  console.log(largestRoute.steps / 2)
}
run()